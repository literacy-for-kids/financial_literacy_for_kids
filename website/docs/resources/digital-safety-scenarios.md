---
sidebar_label: "Digital Safety Scenarios"
title: "Digital Safety Scenario Cards"
description: "Kid-friendly scenarios for practicing digital money safety decisions — used in Weeks 7–8."
---
...
2. Read one card aloud (or give one to each student or pair).
3. For each scenario, discuss:
   - **What is happening?** (Describe the situation.)
   - **What is the risk?** (What could go wrong?)
   - **What should you do?** (What is the safe choice?)
4. After discussing, check the **guidance** at the bottom of each card.

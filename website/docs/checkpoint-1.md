...
sidebar_label: "✓ Unit 1 Checkpoint"
title: "Unit 1 Checkpoint: Value Foundations"
description: "A quick check-in after Weeks 1–4 to see what learners understood, what might need revisiting, and how to celebrate progress."
---
...
1. **Value:** Why might two people disagree about which item is more valuable? Is one of them wrong?
2. **Trade:** If you trade your apple for someone's orange and you are both happy, who got the better deal? (Trick question — both did.)
3. **Money:** What problems does money solve that barter cannot?
4. **Household Economy:** What is the difference between a need and a want? Can something be both?
5. **Connection:** How does the idea of "value" from Week 1 connect to the household budget decisions in Week 4?

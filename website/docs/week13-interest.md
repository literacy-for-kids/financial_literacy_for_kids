---
sidebar_position: 13
sidebar_label: "Week 13: Interest"
title: "Week 13: Interest"
description: "Students discover that money can change over time — growing when saved through interest, or costing more when borrowed. Time is one of the most powerful forces in finance."
---
...
1. The facilitator announces: "Time has passed. The bank pays interest."
2. Students add $0.50 to their balance.
3. Students write the new total in the "Ending Balance" column.
...
**With play money:**
Give each student $10 in tokens. Each round, the facilitator (acting as the bank) hands out $0.50 to every saver. Students physically add the tokens to their pile. The visual of the pile growing reinforces the concept.

**With written balances:**
Students track everything on paper. This version emphasizes the math and pattern-recognition aspects.
